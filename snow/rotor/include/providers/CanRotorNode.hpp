...
namespace Snow {
    ...
    class CanRotorNode : public Snow::CanardInterface  {

    public:

        void startNode(const char *interface_name, std::shared_ptr<Snow::State> state);
    ...
    private:
        ...
        Canard::ObjCallback<Snow::CanRotorNode, uavcan_protocol_GetNodeInfoRequest> node_info_req_cb{this, &handleGetNodeInfo};
        ...
        Canard::ObjCallback<Snow::CanRotorNode, uavcan_protocol_param_GetSetRequest> param_get_set_req_cb{this, &handleParamGetSet};
        ...
        Canard::ObjCallback<Snow::CanRotorNode, uavcan_protocol_param_ExecuteOpcodeRequest> param_executeopcode_req_cb{this, &handleParamExecuteOpcode};
